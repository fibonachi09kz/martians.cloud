...
export const services: ServiceInterface[] = [
	{
		...
		listIcon: () => <Icon className="w-5 h-5 text-current" icon="gg:website" />,
	...
	},
	{
		...
		listIcon: () => <Icon className="w-5 h-5 text-current" icon="iconoir:dev-mode-phone" />,
	...
	},
	{
		...
		listIcon: () => <Icon className="w-5 h-5 text-current" icon="fluent:brain-circuit-20-regular" />,
	...
	},
	{
		...
		listIcon: () => <Icon className="w-5 h-5 text-current" icon="ri:advertisement-fill" />,
	...
	},
	{
		...
		listIcon: () => <Icon className="w-5 h-5 text-current" icon="fluent:design-ideas-16-regular" />,
	...
	},
	{
		...
		listIcon: () => <Icon className="w-5 h-5 text-current" icon="ph:gear" />,
