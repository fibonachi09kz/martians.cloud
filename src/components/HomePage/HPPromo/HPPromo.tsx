					...
					<div className="mt-12 mb-0 lg:relative lg:m-0">
						<div className="mx-auto max-w-md px-4 sm:max-w-2xl sm:px-6 lg:max-w-none lg:px-0">
							<svg className="w-full h-auto lg:w-auto" width="764" height="690" viewBox="0 0 764 690" fill="none" xmlns="http://www.w3.org/2000/svg">
								...
								<path opacity="0.3" d="M329.5 184.4L31.8999 12.6001L31.9999 167.7L303.3 324.3L329.6 363.2L329.5 184.4Z" fill="url(#paint3_linear_291_5495)"/>
								<path d="M0.200195 73.1V31L112.5 95.8V137.9L0.200195 73.1Z" fill="#0064de"/>
								<path className="hover:-translate-x-1 hover:translate-y-[3px] hover:fill-mainBlue hover:opacity-80 transition-all" opacity="0.15" d="M253 178L187.8 140.4V154L253 191.6V178Z" fill="white"/>
								<path className="hover:-translate-x-1 hover:translate-y-[3px] hover:fill-mainBlue hover:opacity-80 transition-all" opacity="0.15" d="M253 205.2L127.3 132.7V146.3L253 218.9V205.2Z" fill="white"/>
								<path className="hover:-translate-x-1 hover:translate-y-[3px] hover:fill-mainBlue hover:opacity-80 transition-all" opacity="0.15" d="M253 232.5L100.7 144.6V158.2L253 246.1V232.5Z" fill="white"/>
								...
								<path className="hover:-translate-x-1 hover:translate-y-[3px] hover:fill-mainBlue hover:opacity-80 transition-all" opacity="0.15" d="M440.7 444.2L505.9 481.8V495.4L440.7 457.8V444.2Z" fill="white"/>
								<path className="hover:-translate-x-1 hover:translate-y-[3px] hover:fill-mainBlue hover:opacity-80 transition-all" opacity="0.15" d="M440.7 471.5L558.4 539.4V553L440.7 485.1V471.5Z" fill="white"/>
								<path className="hover:-translate-x-1 hover:translate-y-[3px] hover:fill-mainBlue hover:opacity-80 transition-all" opacity="0.15" d="M440.7 498.7L593 586.6V600.2L440.7 512.3V498.7Z" fill="white"/>
								...
								<path opacity="0.2" d="M52.2002 321.7L256 439.3V331.9L52.2002 214.3V321.7Z" fill="url(#paint5_linear_291_5495)"/>
								...
								<path className="hover:-translate-x-1 hover:translate-y-[3px] hover:fill-mainBlue hover:opacity-80 transition-all" opacity="0.15" d="M204.1 369.8L73.1001 294.2V280.6L204.1 356.2V369.8Z" fill="white"/>
								<path className="hover:-translate-x-1 hover:translate-y-[3px] hover:fill-mainBlue hover:opacity-80 transition-all" opacity="0.15" d="M203.7 341.9L144.1 307.5V293.9L203.7 328.3V341.9Z" fill="white"/>
								<path opacity="0.2" d="M763.9 464.9L560.2 347.3V454.7L764 572.3L763.9 464.9Z" fill="url(#paint6_linear_291_5495)"/>
								<path className="hover:-translate-x-1 hover:translate-y-[3px] hover:fill-mainBlue hover:opacity-80 transition-all" opacity="0.15" d="M612 403.8L662 432.7V446.3L612 417.4V403.8Z" fill="white"/>
								<path className="hover:-translate-x-1 hover:translate-y-[3px] hover:fill-mainBlue hover:opacity-80 transition-all" opacity="0.15" d="M612.4 430.7L719.9 492.8V506.4L612.4 444.3V430.7Z" fill="white"/>
