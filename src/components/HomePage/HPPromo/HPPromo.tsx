	...
	return (
		<section className="bg-white dark:bg-black">
			<div className="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-12">
				<Link href="/about" className="h-9 px-4 inline-flex justify-between items-center py-1 xs:px-1 pr-4 mb-12 text-sm text-gray-700 bg-gray-100 rounded-full dark:bg-gray-800 dark:text-white hover:bg-gray-200 dark:hover:bg-gray-700" role="alert">
					<span className="hidden xs:inline text-sm bg-primary rounded-full text-white px-4 py-1 mr-3">Martians.cloud</span>
