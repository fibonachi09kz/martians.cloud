	...
	return (
		<div className="mb-12 relative overflow-hidden">
			...
			<div className="w-full grid md:grid-cols-3 gap-5">
				<div className="bg-white dark:bg-black rounded-xl px-6 py-8 flex flex-col">
					...
					<Image src={dev1Img} className="w-full -mb-5 dark:invert mt-auto opacity-60" alt="Full-Stack разработка" />
				</div>
				<div className="bg-white dark:bg-black rounded-xl px-6 py-8 flex flex-col">
					...
					<Image src={dev2Img} className="w-full -mb-5 dark:invert mt-auto opacity-60" alt="UI/UX App Design" />
				</div>
				<div className="bg-white dark:bg-black rounded-xl px-6 py-8 flex flex-col">
					...
					<Image src={dev3Img} className="w-full -mb-[33px] dark:invert mt-auto opacity-60" alt="Обновления" />
				</div>
			</div>
		</div>
	)
