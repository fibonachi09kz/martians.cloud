		...
		<div className="mb-12 p-4 relative overflow-hidden">
			...
			<div className="w-full grid grid-cols-3 gap-5">
				<div className="bg-gray-100 dark:bg-zinc-900 rounded-xl px-4 py-6 flex flex-col">
					<h3 className="text-center text-xl font-bold uppercase mb-3">Full-Stack разработка</h3>
				...
				<div className="bg-gray-100 dark:bg-zinc-900 rounded-xl px-4 py-6 flex flex-col">
					<h3 className="text-center text-xl font-bold uppercase mb-3">UI/UX App Design</h3>
