	...
	return (
		<section className="max-w-7xl mx-auto px-4 py-24">
			...
			<div className="grid md:grid-cols-3 gap-8">
				<div>
					<Icon icon="gg:website" className="text-primary w-10 h-10 flex-none mx-auto" />
				...
				<div>
					<Icon icon="ri:seo-line" className="text-primary w-10 h-10 flex-none mx-auto" />
				...
				<div>
					<Icon icon="fluent:design-ideas-16-regular" className="text-primary w-10 h-10 flex-none mx-auto" />
				...
				<div>
					<Icon icon="solar:server-path-linear" className="text-primary w-10 h-10 flex-none mx-auto" />
				...
				<div>
					<Icon className="text-primary w-10 h-10 flex-none mx-auto" icon="iconoir:www" />
				...
				<div>
					<Icon icon="fluent:person-support-16-regular" className="text-primary w-10 h-10 flex-none mx-auto" />
			...
			<div className="grid md:grid-cols-3 gap-8">
				<div className="p-10 bg-white rounded-2xl col-span-2">
					...
					<Image src="" alt="SEO optimization" />
				</div>
			</div>
		</section>
	)
