		...
		<section className="max-w-7xl mx-auto px-4 py-24">
			...
			<div className="flex flex-wrap justify-center gap-4">
				{services.map(service => (
					<Link href={`/services${service.detailLink}`} key={service.id} className="px-3 py-2 rounded-2xl whitespace-nowrap flex items-center gap-1.5 text-base border hover:border-primary">
