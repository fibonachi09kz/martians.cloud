...
const ProjectDetail = ({ project }: IProjectDetailProps) => {
	return (
        <section className="py-8 md:py-16 antialiased">
            ...
            {project.acf.bigImgDesk && (
                <div className="hidden sm:block max-w-screen-xl rounded-2xl overflow-hidden mt-24 mx-auto">
                    <Image
                        src={project.acf.bigImgDesk.url}
                        alt={project.acf.bigImgDesk.alt}
                        width={project.acf.bigImgDesk.width}
                        height={project.acf.bigImgDesk.height}
                        quality={100}
                        unoptimized
                        blurDataURL={project.acf.bigImgDesk.sizes.medium}
                        className="w-full"
                    />
                </div>
            )}
            {project.acf.bigImgMobile && (
                <div className="block sm:hidden rounded-2xl overflow-hidden mt-24 mx-auto">
                    <Image
                        src={project.acf.bigImgMobile.url}
                        alt={project.acf.bigImgMobile.alt}
                        width={project.acf.bigImgMobile.width}
                        height={project.acf.bigImgMobile.height}
                        quality={100}
                        unoptimized
                        blurDataURL={project.acf.bigImgMobile.sizes.medium}
                        className="w-full"
                    />
                </div>
            )}
